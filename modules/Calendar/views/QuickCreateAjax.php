...
class Calendar_QuickCreateAjax_View extends Vtiger_QuickCreateAjax_View {
	...
	public function  process(Vtiger_Request $request) {
		...
		foreach($moduleList as $module) {
    		...
    		if($returnmodule == 'Project'){
    		    $recordModel->set('event_projectid', $returnrecord);
    		}
    		
    		if($returnmodule == 'ProjectTask'){
    		    $projectTaskRecordModel = Vtiger_Record_Model::getInstanceById($returnrecord);
    		    $projectid = $projectTaskRecordModel->get('projectid');
    		    $recordModel->set('event_projecttaskid', $returnrecord);
    		    $recordModel->set('event_projectid', $projectid);
    		}
