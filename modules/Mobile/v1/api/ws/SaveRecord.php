		...
		try {
			if (vtws_recordExists($recordid)) {
               ...
               if (isset($this->recordValues['id'])) {
                ...
                $response->setApiSucessMessage('Successfully Fetched Data',200);
                ...
                if($module == 'ModComments'){
    				...
    				$responseComment = new Mobile_API_Response();
    				$responseComment->setResult($data);
    				$responseComment->setApiSucessMessage($message);
