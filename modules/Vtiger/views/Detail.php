...
class Vtiger_Detail_View extends Vtiger_Index_View {
	...
	function preProcess(Vtiger_Request $request, $display=true) {
		...
		if($moduleName == 'Project'){
			$opportunityId = $recordModel->get('potentialid');
		...
		if($moduleName == "Project"){
			...
			$getOpportunitiesRecord = $adb->pquery("SELECT * FROM vtiger_modulestatus_label");
			$record = $adb->fetchByAssoc($getOpportunitiesRecord);
			...
			$viewer->assign('payment_received', $payment_received);
			$viewer->assign('implementation', $implementation);
			$viewer->assign('installation', $installation);
			$viewer->assign('site_verification', $site_verification);
		...
		if($moduleName == 'Leads'){
			...
			$getStatusLabelRecord = $adb->pquery("SELECT * FROM vtiger_modulestatus_label");
			$record = $adb->fetchByAssoc($getStatusLabelRecord);
