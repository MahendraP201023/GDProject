...
$module->name = 'ExtraWork';//(No space in module name)
$module->save();
...
$block1->label = 'ExtraWork Information';
$module->addBlock($block1); //to create a new block

$field0 = new Vtiger_Field();
$field0->name = 'extrawork_description';
$field0->label = 'Extra Work';
$field0->table = $module->basetable; 
$field0->column = 'extrawork_description';
...
$field018->name = 'extrawork_project'; 	
$field018->label = 'Project Name'; 
$field018->column = 'extrawork_project';
$field018->uitype = 10; 
...
$field1->name = 'extrawork_no';
$field1->label = 'ExtraWork No';
$field1->table = $module->basetable; 
$field1->column = 'extrawork_no';
