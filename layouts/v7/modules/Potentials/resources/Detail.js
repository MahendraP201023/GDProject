...
Vtiger_Detail_Js("Potentials_Detail_Js",{
	...
	registerEventForFollowUp : function(e) {
		jQuery(document).ready(function($) {
			$('#advancePayment').off('change').on('change', function() {
		...
		jQuery(document).ready(function($) {
			$('#quotesReady').off('change').on('change', function(){
		...
		jQuery(document).ready(function($) {
			$('#siteVisit').off('change').on('change', function(){
...
// 	},
		...
		jQuery(document).ready(function($) {
			$('#design3d').off('change').on('change', function() {
				var design2d = $(this).is(':checked');
				var record = $('#recordId').val();
				var params = {
					module: 'Leads',
