        ...
        <div class="record-header clearfix">
            ...
            <div class="recordBasicInfo">
                ...
                *}
                ...
                <div class="progress "  style="margin: -90px -238px 0px 0px">
                    <div class="circle {if $advancePayment eq '1'} active {/if}">
                        <span class="label">✓</span>
                        <span class="title" style="padding-top: 8px;" title="{if $advance_payment} {$advance_payment} {else} Advance Payment {/if}">
                            {if $advance_payment} {$advance_payment} {else} Advance Payment {/if}
                        </span>
                    </div>
                    ...
                    <div class="circle {if $quotesReady eq '1'} active {/if}">
                        <span class="label">✓</span>
                        <span class="title" style="padding-top: 8px;" title="{if $quotes_ready} {$quotes_ready} {else} Quotes Ready {/if}">
                            {if $quotes_ready} {$quotes_ready} {else} Quotes Ready {/if}
                        </span>
                    </div>
                    ...
                    <div class="circle {if $siteVisit eq '1'} active {/if}">
                        <span class="label">✓</span>
                        <span class="title" style="padding-top: 8px;" title="{if $site_visit} {$site_visit} {else} Site Visit {/if}">
                            {if $site_visit} {$site_visit} {else} Site Visit {/if}
                        </span>
                    </div>
                    ...
                    <div class="circle {if $design2d eq '1'} active {/if}">
                        <span class="label">✓</span>
                        <span class="title" style="padding-top: 8px;" title="{if $design_1} {$design_1} {else} 2D design  {/if}">
                            {if $design_1} {$design_1} {else} 2D design  {/if}
                        </span>
                    </div>
                    ...
                    <div class="circle {if $design3d eq '1'} active {/if}">
                        <span class="label">✓</span>
                        <span class="title" style="padding-top: 8px;" title="{if $design_2} {$design_2} {else} 3D design {/if}">
                            {if $design_2} {$design_2} {else} 3D design {/if}
                        </span>
                    </div>
                </div>
