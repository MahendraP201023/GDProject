...
{strip}
	<style>
		body {
			background: linear-gradient(0deg, rgba(0,0,0,0.40), rgba(0,0,0,0.40)), url(layouts/v7/resources/Images/inncabg-min.jpg);
		...
		.buttonBlue {
			background-image: linear-gradient(to bottom, #112013 0px, #35aa47 100%)
		}
		.ripples {
			position: absolute;
			top: 0;
	...
	<div class="container-fluid loginPageContainer">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="test/logo/JD_Grp(3).jpg">
				<div>
