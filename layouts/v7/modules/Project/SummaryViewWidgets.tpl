...
{strip}
	...
	<div class="right-block col-lg-4 col-md-4 col-sm-4">
		...
		<!-- //New changed for 2d 3d attachment -->
		<div class="summaryWidgetContainer">
			<div class="widgetContainer_contacts">
				<div class="widget_header clearfix">
					...
					{if $row2D eq 0}
						<div>
							<button class="btn btn-success select2Dattachment hide" >{vtranslate('Select 2D Design',$MODULE_NAME)}</button>
						</div>
					{/if}
				</div>
				<div class="">
					{if $design2DType eq 'image/png' || $design2DType eq 'image/jpeg'}
		...
		<div class="summaryWidgetContainer">
			<div class="widgetContainer_contacts">
				<div class="widget_header clearfix">
					...
					{if $row3D eq 0}
						<div>
							<button class="btn btn-success select3Dattachment hide" >{vtranslate('Select 3D Design',$MODULE_NAME)}</button>
						</div>
					{/if}
				</div>
				<div class="">
					{if $design3DType eq 'image/png' || $design3DType eq 'image/jpeg'}
