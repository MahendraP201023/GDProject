        ...
        <div class="widgetContainer_comments">
            ...
            <div class="widget_contents1">
                <table class="class="table table-borderless"">
                    <tr>
                        <td>
                            <input type="checkbox" name="1stfollow" id="1stfollow" {if $follow1st eq '1'} checked {/if}> 1st Follow Up<br><br>
                        <td>
                    <tr>
                    <tr>
                        <td>
                            <input type="checkbox" name=2ndfollow" id="2ndfollow" {if $follow2nd eq '1'} checked {/if}> 2nd Follow Up<br><br>
                        <td>
                    <tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="3rdfollow" id="3rdfollow" {if $follow3rd eq '1'} checked {/if}> 3rd Follow Up<br><br>
                        <td>
                    <tr>
                </table>
            </div>
