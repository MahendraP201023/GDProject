...
Vtiger_Edit_Js("Calendar_Edit_Js",{
	...
	registerBasicEvents : function(container) {
		...
		$('.editViewContents').find('[data-block="LBL_REMINDER_INFORMATION"]').addClass('hide'); 
		$('.editViewContents').find('[data-block="LBL_RECURRENCE_INFORMATION"]').addClass('hide'); 
		$('.editViewContents').find('[data-block="LBL_RELATED_TO"]').addClass('hide'); 
		$('.editViewContents').find('[data-block=""]').addClass('hide'); 
