...
<div class="container mt-5">
    ...
    <form class="form-horizontal recordEditView" id="editview" name="edit" method="post" action="index.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="inputType" class="col-sm-2 control-label">Modules name:</label>
            <div class="col-sm-6">
            ...
            <div class="followup" id="followupContainer">
                <div class="opportunities hidden-section">
                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Advance Payment</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="advance_payment" id="advance_payment" value="{$ADVANCE_PAYMENT}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Quotes Ready</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="quotes_ready" id="quotes_ready" value="{$QUOTES_READY}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Site Visit</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="site_visit" id="site_visit" value="{$SITE_VISIT}"></div></div>
                    
                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">2D design</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="design_1" id="design_1" value="{$DESIGN_1}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">3D design</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="design_2" id="design_2" value="{$DESIGN_2}"></div></div><br><br>
                </div>
                <div class="leads hidden-section">
                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Followup 1</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="followup_1" id="followup_1" value="{$FOLLOWUP_1}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Followup 2</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="followup_2" id="followup_2" value="{$FOLLOWUP_2}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Innca Visit</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="innca_visit" id="innca_visit" value="{$INNCA_VISIT}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Followup 3</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="followup_3" id="followup_3" value="{$FOLLOWUP_3}"></div></div><br><br>
                </div>
                <div class="project hidden-section">
                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Discussion and payment received</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="payment_received" id="payment_received" value="{$DISC_PAYMENT_RECEIVED}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Implementation</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="implementation" id="implementation" value="{$IMPLEMENT}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Installation</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="installation" id="installation" value="{$INSTALLATION}"></div></div>

                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input">Site Verification</label><div class="col-sm-4 select2">
                    <input class="form-control select2" type="text" name="site_verification" id="site_verification" value="{$SITE_VERFICATION}"></div></div>
                    
                    <div class="form-group"><label class="col-sm-2 control-label select2" for="input" >Closure</label><div class="col-sm-4 select2">
