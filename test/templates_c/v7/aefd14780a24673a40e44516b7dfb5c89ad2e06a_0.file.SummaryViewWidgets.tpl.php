<?php
/* Smarty version 3.1.39, created on 2024-04-15 12:05:00
  from '/home2/bitechnosys/jd-grp.crm-doctor.com/layouts/v7/modules/Project/SummaryViewWidgets.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_661d17ec0d4193_29003818',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'aefd14780a24673a40e44516b7dfb5c89ad2e06a' => 
    array (
      0 => '/home2/bitechnosys/jd-grp.crm-doctor.com/layouts/v7/modules/Project/SummaryViewWidgets.tpl',
      1 => 1711095256,
      2 => 'file',
    ),
  ),
...
function content_661d17ec0d4193_29003818 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div><?php }?></div></div><div class="widget_contents"></div></div></div><?php }?><!-- //New changed for 2d 3d attachment --><div class="summaryWidgetContainer"><div class="widgetContainer_contacts"><div class="widget_header clearfix"><h4 class="display-inline-block pull-left"><?php echo vtranslate('2D Design',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</h4><br><br><?php if ($_smarty_tpl->tpl_vars['row2D']->value == 0) {?><div><button class="btn btn-success select2Dattachment hide" ><?php echo vtranslate('Select 2D Design',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</button></div><?php }?></div><div class=""><?php if ($_smarty_tpl->tpl_vars['design2DType']->value == 'image/png' || $_smarty_tpl->tpl_vars['design2DType']->value == 'image/jpeg') {?><img src="<?php echo $_smarty_tpl->tpl_vars['design2D']->value;?>
...
</h4><br><br><?php if ($_smarty_tpl->tpl_vars['row3D']->value == 0) {?><div><button class="btn btn-success select3Dattachment hide" ><?php echo vtranslate('Select 3D Design',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</button></div><?php }?></div><div class=""><?php if ($_smarty_tpl->tpl_vars['design3DType']->value == 'image/png' || $_smarty_tpl->tpl_vars['design3DType']->value == 'image/jpeg') {?><img src="<?php echo $_smarty_tpl->tpl_vars['design3D']->value;?>
" style="width: 80px;"/><?php } else { ?><span><?php echo $_smarty_tpl->tpl_vars['design3DFile']->value;?>
</span><?php }?></div></div></div><!-- //New changed for 2d 3d attachment --></div>
<?php }
}
