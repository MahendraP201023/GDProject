...
/* Smarty version 3.1.39, created on 2024-05-07 12:50:26
  from '/home2/bitechnosys/jd-grp.crm-doctor.com/layouts/v7/modules/ServiceEngineer/ListViewActions.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_663a23925d7b67_64017548',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4bb650c45c5ae55ce94449530921c1d4cf8e5fc2' => 
    array (
      0 => '/home2/bitechnosys/jd-grp.crm-doctor.com/layouts/v7/modules/ServiceEngineer/ListViewActions.tpl',
      1 => 1702537022,
      2 => 'file',
    ),
  ),
...
function content_663a23925d7b67_64017548 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?><div class = "row"><div class=" col-md-3"><div class="btn-group listViewActionsContainer" role="group" aria-label="..."><?php if ($_smarty_tpl->tpl_vars['commentAction']->value) {?><button type="button" class="btn btn-soft-primary" id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
if (count($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTIONS_1']->value) > 0 || count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEW']) > 0) {?><div class="btn-group listViewMassActions" role="group"><button type="button" class="btn btn-soft-secondary btn-sm dropdown-toggle" data-toggle="dropdown"><?php echo vtranslate('LBL_MORE','Vtiger');?>
...
if (count($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTIONS_1']->value) > 0 && count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEW']) > 0) {?><li class="divider hide"></li><?php }
...
</a></center></div></div><div class="col-md-5"><?php $_smarty_tpl->_assignInScope('RECORD_COUNT', $_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value);
