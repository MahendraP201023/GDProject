<?php
/* Smarty version 3.1.39, created on 2024-03-15 05:29:06
  from '/home2/bitechnosys/incca.crm-doctor.com/layouts/v7/modules/ServiceEngineer/DetailViewActions.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_65f3dca241b847_15153905',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '36dcdc8bc3e529dcac96b359545613810b6b4e2f' => 
    array (
      0 => '/home2/bitechnosys/incca.crm-doctor.com/layouts/v7/modules/ServiceEngineer/DetailViewActions.tpl',
      1 => 1702537022,
      2 => 'file',
    ),
  ),
...
function content_65f3dca241b847_15153905 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isStarredEnabled()) {?><button class="btn btn-soft-blue markStar <?php if ($_smarty_tpl->tpl_vars['STARRED']->value) {?> active <?php }?>" id="starToggle" style="width:100px;"><div class='starredStatus' title="<?php echo vtranslate('LBL_STARRED',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel() != 'LBL_EDIT') {?><button class="btn btn-soft-info" id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
if (!$_prefixVariable3) {?><div class="btn-group pull-right"><button class="btn btn-soft-secondary" id="detailViewPreviousRecordButton" <?php if (empty($_smarty_tpl->tpl_vars['PREVIOUS_RECORD_URL']->value)) {?> disabled="disabled" <?php } else { ?> onclick="window.location.href = '<?php echo $_smarty_tpl->tpl_vars['PREVIOUS_RECORD_URL']->value;?>
&app=<?php echo $_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value;?>
